...
############################# LINE DATA #############################
df = pd.read_csv(line_csv, engine='python', skiprows=lambda x: x in [0], skipfooter=2)
...
############################ SYMBOL DATA ############################
df = pd.read_csv(symbol_csv, engine='python', skiprows=lambda x: x in [0], skipfooter=2)
